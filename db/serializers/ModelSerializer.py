...
class ModelSerializer:
    ...
    def serialize_geo_info(geo_item: GeoInfo, alternames=None) -> Dict[str, Any]:
        return {'geonameid': geo_item.geonameid, 'name': geo_item.name, 'asciiname': geo_item.asciiname,
                'alternatenames': alternames if alternames else "", 'latitude': geo_item.latitude,
                'longitude': geo_item.longitude,
                'feature class': geo_item.feature_class, 'feature_code': geo_item.feature_code,
                'country_code': geo_item.country_code, 'cc2': geo_item.cc2, 'admin1_code': geo_item.admin1_code,
                'admin2_code': geo_item.admin2_code, 'admin3_code': geo_item.admin3_code,
                'admin4_code': geo_item.admin4_code, 'population': geo_item.population, 'elevation': geo_item.elevation,
                'dem': geo_item.dem, 'timezone': geo_item.timezone, 'modification_date': geo_item.modification_date}
